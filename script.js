...
function setInputField(inputValue, check) {
  ...
  inputfield = `<div class="field_container">
          ...
          <form action="">
            ...
            <div>
              <input type="checkbox" name="checkbox" id="reqField" value="require" ${c}> <span>required</span>
            </div>
          </form>
          <section class="buttons">
            <button class = "exit" type="button">Cancel</button>
...
function setOptionsField(inputValue, answers, require, type) {
  ...
  optionsfield = `<div class="field_container">
          ...
          <form action="">
            ...
            <div>
              <input type="checkbox" name="checkbox" id="reqField" value="require" ${req}><span>required</span>
            </div>
            ${radioOrCheck}
            ${options}
...
function getLabelType() {
  ...
  const value = itemContainer.querySelector("#label_types").value;
  ...
  //add
  itemContainer.querySelector(".add").addEventListener("click", () => {
    let selectedValue = itemContainer.querySelector("#label_types").value;
  ...
  //cancel
  itemContainer.querySelector(".exit").addEventListener("click", () => {
...
function addText(id) {
  //variables
  const inputValue = itemContainer.querySelector("#label").value;
  let require = "";

  //checking for require field
  if (itemContainer.querySelector("#reqField").checked) {
